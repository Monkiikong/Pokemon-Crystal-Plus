...
FalknerGroup:
	...
	db  7, NATU, NO_ITEM,      PECK, FLASH, NO_MOVE, NO_MOVE
...
WhitneyGroup:
	...
	db 18, TEDDIURSA, NO_ITEM,  SCRATCH, FURY_SWIPES, ATTRACT, ROLLOUT
	db 19, SNUBBULL, NO_ITEM,   TACKLE, CHARM, BITE, ATTRACT
...
BugsyGroup:
	...
	db 14, PINECO, NO_ITEM,   TACKLE, PROTECT, SELFDESTRUCT, NO_MOVE
	db 14, SPINARAK, NO_ITEM,    POISON_STING, STRING_SHOT, SCARY_FACE, NO_MOVE
...
MortyGroup:
	...
	db 25, GENGAR, SPELL_TAG,    HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 23, MISDREAVUS, SPELL_TAG,   PSYWAVE, SPITE, MEAN_LOOK, SHADOW_BALL
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	db 27, SNEASEL, MINT_BERRY,   HEADBUTT, ICY_WIND, FAINT_ATTACK, REST
	db 29, DEWGONG, MINT_BERRY,   HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 31, PILOSWINE, NEVERMELTICE, ICY_WIND, FURY_ATTACK, MIST, BLIZZARD
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	db 30, SKARMORY, NO_ITEM, STEEL_WING, SWAGGER, SWIFT, FLY
	db 33, SCIZOR, NO_ITEM, METAL_CLAW, FURY_CUTTER, AGILITY, WING_ATTACK
	db 35, STEELIX, METAL_COAT,   SCREECH, SUNNY_DAY, ROCK_THROW, IRON_TAIL
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "DUSTIN@", TRAINERTYPE_ITEM_MOVES
	db 27, GLIGAR, NO_ITEM,    EARTHQUAKE, WING_ATTACK, SANDSTORM, TOXIC
	db 27, QUAGSIRE, NO_ITEM,  SURF, EARTHQUAKE, CURSE, AMNESIA
	db 30, DONPHAN, SOFT_SAND, EARTHQUAKE, ROLLOUT, ROAR, DEFENSE_CURL
	db -1 ; end
...
ClairGroup:
	...
	db 40, KINGDRA,  DRAGON_SCALE,  SMOKESCREEN, SURF, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
...
WillGroup:
	...
	db 40, GIRAFARIG, BRIGHTPOWDER,    TOXIC, DOUBLE_TEAM, PROTECT, PSYCHIC_M
	db 41, ESPEON, MINT_BERRY,          REST, SWIFT, SHADOW_BALL, PSYCHIC_M
	db 41, EXEGGUTOR, NO_ITEM,          REFLECT, LEECH_SEED, EGG_BOMB, PSYCHIC_M
	db 41, SLOWKING,  KINGS_ROCK,       CURSE, AMNESIA, SURF, PSYCHIC_M
	db 42, XATU, TWISTEDSPOON,         QUICK_ATTACK, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	db -1 ; end
...
HikerGroup:
	...
	db 27, DUGTRIO,  MAGNITUDE, DIG, CURSE, SLASH
	db -1 ; end
	
	; BLACKBELT_T (4)
	db "LAO@", TRAINERTYPE_MOVES
	db 27, GLIGAR, TOXIC, FAINT_ATTACK, PROTECT, SAND_ATTACK
	db -1 ; end

	; BLACKBELT_T (5)
	db "NOB@", TRAINERTYPE_MOVES
	db 25, WOOPER,     TAIL_WHIP, AMNESIA, WATER_GUN, DIG
	db 25, QUAGSIRE,    TAIL_WHIP, AMNESIA, SURF, EARTHQUAKE
	db -1 ; end
