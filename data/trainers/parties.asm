...
ChuckGroup:
	; CHUCK (1)
	db "DUSTIN@", TRAINERTYPE_MOVES
	db 27, GLIGAR,     EARTHQUAKE, WING_ATTACK, SANDSTORM, TOXIC
	db 27, QUAGSIRE,   SURF, EARTHQUAKE, CURSE, AMNESIA
	db 30, DONPHAN,  EARTHQUAKE, ROLLOUT, ROAR, DEFENSE_CURL
	db -1 ; end
