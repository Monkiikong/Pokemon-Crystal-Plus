...
IcePathArticuno:
	...
	setevent EVENT_ICE_PATH_ARTICUNO
...
IcePathB3F_MapEvents:
	...
	object_event 9, 3, SPRITE_ARTICUNO, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, PERSONTYPE_SCRIPT, 0, IcePathArticuno, EVENT_ICE_PATH_ARTICUNO
