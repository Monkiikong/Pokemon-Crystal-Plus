...
CinnabarIslandMoltres:
	...
	setevent EVENT_CINNABAR_ISLAND_MOLTRES
...
CinnabarIsland_MapEvents:
	...
	db 2 ; object events
	object_event  7,  12, SPRITE_BLUE, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CinnabarIslandBlue, EVENT_BLUE_IN_CINNABAR
	object_event 9, 6, SPRITE_MOLTRES, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, PERSONTYPE_SCRIPT, 0, CinnabarIslandMoltres, EVENT_CINNABAR_ISLAND_MOLTRES
