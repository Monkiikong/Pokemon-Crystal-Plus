...
CianwoodCityLassDoll:
	faceplayer
	opentext
	checkevent EVENT_DECO_TENTACOOL_DOLL
	iftrue .TentaDollAlreadyGot
	writetext TentaDoll
	waitbutton
...
TentaDoll:
	...
	line "I have heaps of"
	
	para "that one. I"
	line "collect tentacool"
...
CianwoodCity_MapEvents:
	...
	object_event 27, 44, SPRITE_LASS, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CianwoodCityLassDoll, -1