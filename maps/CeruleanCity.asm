...
CeruleanCityMewtwo:
	...
	setevent EVENT_CERULEAN_CITY_MEWTWO
...
CeruleanCity_MapEvents:
	...
	bg_event  2, 13, BGEVENT_ITEM, CeruleanCityHiddenBerserkGene
	...
	object_event 2, 14, SPRITE_MEWTWO, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, PERSONTYPE_SCRIPT, 0, CeruleanCityMewtwo, EVENT_CERULEAN_CITY_MEWTWO
