	...
	const GOLDENRODGAMECORNER_CONSOLECLERK
...
ConsoleClerkScript:
	...
	opentext
.Begin:
	writetext ConsoleClerk
	special PlaceMoneyTopRight
	loadmenu .ConsoleMenu
	verticalmenu
	closewindow
	ifequal $1, .Nes
	ifequal $2, .SuperNes
...
.Nes
	checkmoney $0, 15000
	ifequal $2, .NotEnoughMoneyConsole
	checkevent EVENT_DECO_FAMICOM
	iftrue .AlreadyBoughtConsole
	takemoney $0, 15000
...
.SuperNes
	...
	writetext BoughtSuperNesText
	playsound SFX_TRANSACTION
	waitbutton
	writetext SuperNesSentText
	waitbutton
	jump .Begin
...
.NotEnoughMoneyConsole:
	writetext ConsoleNoMoney
	waitbutton
	jump .Begin

.AlreadyBoughtConsole:
	writetext ConsoleDuplicate
	waitbutton
	jump .Begin
...
GoldenrodGameCorner_MapEvents:
	...
	object_event 9,  1, SPRITE_CLERK, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, ConsoleClerkScript, -1
