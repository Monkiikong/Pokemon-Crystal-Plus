...
VictoryRoad_MapEvents:
	...
	object_event 6,  27, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, HikerPokeDollGift, -1
