...
SPRITE_POKEMON EQU const_value
	...
	const SPRITE_SLOWPOKE ; b0
	const SPRITE_MEOWTH ; b1
	const SPRITE_NIDORAN_F ; b2
	const SPRITE_POLIWRATH ; b3
	const SPRITE_FARFETCH_D ; b4
	const SPRITE_BLISSEY ; b5
	const SPRITE_DODRIO ; b6
	const SPRITE_PSYDUCK ; b7
	const SPRITE_NIDORINO ; b8
	const SPRITE_PIDGEY ; b9
	const SPRITE_PERSIAN ; c0
	const SPRITE_BAYLEEF ; c1
	const SPRITE_FEAROW ; c2
	const SPRITE_MILTANK ; c3
	const SPRITE_ELECTRODE ; c4
	const SPRITE_MURKROW ; c5
	const SPRITE_SPEAROW ; c6
